...
/*personal detail*/
const namemodel = ref('Bach Bui');
const storemodel = ref('Bach Bui');
const storemail = ref('bach@gmail.com');
const storephone = ref('+84 123 456 789');
const storeaddress = ref('Ho Chi Minh City, Vietnam');
</script>
